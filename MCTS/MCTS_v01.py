...
class MCTS:
    ...
    ## calculating the scores
            v_score = 0
            v_score,flag,count = self.simulation(parent.children[o],i,p_puzzle,count)
    ...
    def simulation(self,p,i,p_puzzle,count):
        layers = self.layers
        flag = self.flag
    ...
    #If no children remove the parent from the children list of its parent
                    if len(parent.children) == 0:
                        ...
                        while (len(parent.children)==0):
                            ...
                            if isinstance(parent.parent, basestring):
                                exit()
